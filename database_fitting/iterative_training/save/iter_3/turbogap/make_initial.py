...
# no of H and no of C
nH = 25 #random.choice([20, 25, 30])
nat = [nH, N-nH]
print("number of hydrogens", nH)
rho = 1. # (initial) density in g/cm3 - this can change if barostatting is used
T0 = 5000. # (initial) temperature in K - this determines random velocities
##################################################################
...
atoms = Atoms("H%iC%i" % (nat[0], nat[1]), cell = cell, positions = positions, pbc = True)
