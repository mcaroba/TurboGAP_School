...
gap_fit atoms_filename=train_tagged.xyz core_param_file=pairpot_mod.xml core_ip_args={IP Glue} \
        gap={ \
              distance_2b Z1=1 Z2=1 cutoff=4.0 n_sparse=30 covariance_type=ard_se \
                  delta=0.5 theta_uniform=0.5 sparse_method=uniform add_species=F : \
              distance_2b Z1=1 Z2=6 cutoff=4.0 n_sparse=30 covariance_type=ard_se \
                  delta=0.5 theta_uniform=0.5 sparse_method=uniform add_species=F : \
              distance_2b Z1=6 Z2=6 cutoff=4.0 n_sparse=30 covariance_type=ard_se \
                  delta=0.5 theta_uniform=0.5 sparse_method=uniform add_species=F : \
              angle_3b Z_center=6 Z1=1 Z2=1 cutoff=2.0 n_sparse=200 covariance_type=pp \
                  delta=0.01 theta_uniform=2.0 sparse_method=uniform add_species=F : \
              angle_3b Z_center=6 Z1=1 Z2=6 cutoff=2.0 n_sparse=200 covariance_type=pp \
                  delta=0.01 theta_uniform=2.0 sparse_method=uniform add_species=F : \
              angle_3b Z_center=6 Z1=6 Z2=6 cutoff=2.0 n_sparse=200 covariance_type=pp \
                  delta=0.01 theta_uniform=2.0 sparse_method=uniform add_species=F : \
